...
class LessThanComparisonTest extends QueryBaseTestCase
{
	public function testPropertyAndReferenceValueGetSetOnInitialization()
	{
		$age = 25;
		$comparison = new LessThanComparison($this->property, $age);
	...
	public function testComparisonIsNotTypeStrict()
	{
		...
		$comparison = new LessThanComparison($this->property, $compareValue);
	...
	{
		$comparison = new LessThanComparison($this->property, 16);
	...
	public function testLogicalAndCompositionWithOtherConditionCanBeBuilt()
	{
		...
		$comp = new LessThanComparison('3', '4');
