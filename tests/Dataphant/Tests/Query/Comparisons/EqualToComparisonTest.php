...
class EqualToComparisonTest extends QueryBaseTestCase
{
	public function testRecordsPropertyMatchesNumericValueIfEqual()
	{
		...
		$comparison = new EqualToComparison($this->property, $compareValue);
	...
	{
		$comparison = new EqualToComparison($this->property, 16);
	...
	public function testLogicalAndCompositionWithOtherConditionCanBeBuilt()
	{
		...
		$comp = new EqualToComparison('3', '4');
